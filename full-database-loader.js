// V/E Finder v3.6: load the full 492-station database and normalize source provenance.
...
(() => {
  ...
  const parts = [
    'data/stations-461.part00.b64?v=20260822-36',
    'data/stations-461.part01.b64?v=20260822-36',
    'data/stations-461.part02.b64?v=20260822-36',
    'data/stations-461.part03.b64?v=20260822-36',
    'data/stations-461.part04.b64?v=20260822-36'
  ];
  ...
  async function loadFullDatabase() {
    ...
    if (!Array.isArray(data) || data.length !== 492) {
