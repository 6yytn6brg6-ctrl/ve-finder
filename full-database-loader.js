// V/E Finder v4.2: load the full 498-station database and normalize source provenance.
...
(() => {
  ...
  const parts = [
    'data/stations-461.part00.b64?v=20260823-43',
    'data/stations-461.part01.b64?v=20260823-43',
    'data/stations-461.part02.b64?v=20260823-43',
    'data/stations-461.part03.b64?v=20260823-43',
    'data/stations-461.part04.b64?v=20260823-43'
  ];
  ...
  async function loadFullDatabase() {
    ...
    if (!Array.isArray(data) || data.length !== 498) {
